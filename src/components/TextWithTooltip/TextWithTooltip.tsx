      ...
      <>
        ...
        <Paper shadow="xs" radius="md" p="md" withBorder mt={50}>
          ...
          <List spacing={2} size="sm" listStyleType="disc" withPadding>
            <List.Item>
              Выделите любой фрагмент текста в статье выше, автоматически
              появится всплывающее окно с переводом.
            </List.Item>
            <List.Item>
              В tooltip вы можете выбрать язык, на который хотите перевести
              выбранный текст.
            </List.Item>
            <List.Item>
              Также tooltip имеет функцию озвучивания выбранного и переведенного
              текста.
            </List.Item>
            <List.Item>
              Выберите язык страницы, чтобы увидеть контент на разных языках.
            </List.Item>
            <List.Item>
              По нажатию на кнопку "Open translator" откроется модальное окно с
